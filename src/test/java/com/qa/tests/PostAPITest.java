...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		//object to json file:
		mapper.writeValue(new File("/Users/SubhajitGhosh/Documents/APIAutomationHTTPClient/APIAutomationUsingHTTPClient/src/main/java/com/qa/data/users.json"), users);
